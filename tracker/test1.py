...
cap=cv2.VideoCapture('/Users/praneshkrishnanragunathan/Downloads/yolov8-opencv-win11-main/vidyolov8.mp4')
...
while True:
    ...
    count=len(area_c)
    cv2.putText(frame,str(count),(61,146),cv2.FONT_HERSHEY_PLAIN,5,(255,0,0),2)
